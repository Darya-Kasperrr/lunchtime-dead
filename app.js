...
(function () {
  ...
  const DICT = {
    en: {
      ...
      'cast.role': 'ROLE', 'cast.origin': 'ORIGIN', 'cast.style': 'STYLE', 'cast.track': 'TRACK', 'cast.band': 'BAND',
      'cast.m1.role': 'Lead Vocals', 'cast.m1.origin': 'Hiroshima', 'cast.m1.style': 'City Pop ・ Nocturne Jazz',
      'cast.m1.track': 'Tsubame big joy — A city with Green',
    ...
    ja: {
      ...
      'cast.role': '役割', 'cast.origin': '出身', 'cast.style': 'スタイル', 'cast.track': '楽曲', 'cast.band': 'バンド',
      'cast.m1.role': 'リードボーカル', 'cast.m1.origin': '広島', 'cast.m1.style': 'シティ・ポップ ・ 夜想ジャズ',
      'cast.m1.track': 'ツバメ・ビッグ・ジョイ — 緑のある街',
